                                ...
                                >
                                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                                        ...
                                        <div className="flex-grow">
                                            <h3 className="font-bold text-cyan-900 text-lg">{item.nombre}</h3>
                                            <div className="grid grid-cols-2 gap-4 mt-2">
                                                <div>
                                                    <p className="text-sm text-cyan-700/80">Cantidad:</p>
                                                    <p className="font-medium text-gray-700/90">{item.cantidad}</p>
                                                </div>
                                                <div>
                                                    <p className="text-sm text-cyan-700/80">Precio unitario:</p>
                                                    <p className="font-medium text-gray-700/90">S/. {item.precio.toFixed(2)}</p>
                                                </div>
                                                <div>
                                                    <p className="text-sm text-cyan-700/80">Subtotal:</p>
                                                    <p className="font-medium text-gray-700/90">S/. {(item.precio * item.cantidad).toFixed(2)}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex-shrink-0">
                            ...
                            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-sm border border-white/50 sticky top-4">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between">
                                        <span className="text-cyan-700/90">Subtotal:</span>
                                        <span className="font-medium text-gray-700/90">S/. {subtotal.toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-cyan-700/90">IGV (18%):</span>
                                        <span className="font-medium text-gray-700/90">S/. {igv.toFixed(2)}</span>
                                    </div>
